...
import Stitches, { ComponentProps as ComponentProps$1 } from '@stitches/react';
import * as react from 'react';
import { ElementType, ComponentProps } from 'react';
import * as Avatar$1 from '@radix-ui/react-avatar';
import * as Checkbox$1 from '@radix-ui/react-checkbox';

declare const Box: _stitches_react_types_styled_component.StyledComponent<"button", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
...
declare type BoxProps = Stitches.ComponentProps<typeof Box> & {
    as?: ElementType;
};
...
declare type TextProps = Stitches.ComponentProps<typeof Text> & {
    as?: ElementType;
};
...
declare type HeadingProps = Stitches.ComponentProps<typeof Heading> & {
    as?: ElementType;
};
...
declare const TextInput: {
    ({ prefix, ...rest }: TextInputProps): JSX.Element;
    displayName: string;
};
...
declare const MultiStep: {
    ({ size, currentStep }: MultiStepProps): JSX.Element;
    displayName: string;
};
...
declare const Toast: ({ title, description, onClose }: ToastProps) => JSX.Element;
