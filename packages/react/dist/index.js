  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(MultiStepContainer, {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Steps, {
        ...
        children: Array.from({ length: size }, (_, i) => i + 1).map((step) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Step, {
...
var ToastTitle = styled(Heading, {
  color: "$white",
  fontSize: "$xl"
});
var ToastDescription = styled(Text, {
  color: "$gray200",
  fontSize: "$sm"
});
...
var Toast = ({ title, description, onClose }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(ToastContainer, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ToastCloseButton, {
